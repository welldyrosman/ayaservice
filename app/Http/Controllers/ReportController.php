...
class ReportController extends Controller
{
    public function dailyincomereport(Request $request){
        try{
            ...
            $sql=DB::select("with sumresep as(
            ...
            ,summed as(
                select sum(fee) as feeamt,cast(created_at as date) as med_days,count(id) as visit_qty from medical group by cast(created_at as date)
            )
