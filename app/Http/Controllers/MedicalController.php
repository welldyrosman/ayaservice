...
class MedicalController extends Controller{
    ...
    private function detailmed($id){
        ...
        $medicalscren=DB::select("select f.formkind_id,f.medkind_id,f.dokter_only,s.created_at,s.updated_at,s.id,f.id as medform_id,s.val_desc,k.nama as label_kind,k.datatype from medical m
        ...
        where m.id=$id");
        $resep=DB::select("select b.id,b.iscomposite,d.qty,d.unit,b.harga,b.nama from resep r
